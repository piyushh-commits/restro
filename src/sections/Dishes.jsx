  ...
  return (
    <section id='dishes' className='px-auto mt-44'>
        <div className="text-center mb-16">
            <Animated delay={0.2}>
                <p className='text-orange-600 font-medium uppercase mb-3.5'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-18 max-w-5xl mx-auto'>
            {dishes.map((dish, index)=>(
                <Animated key={index} y={80} delay={index * 0.1} className='flex flex-col items-center text
                -center shrink-0 cursor-pointer'
